...
export const metadata: Metadata = {
  ...
  description:
    'Connect with the 02Ship community on X, GitHub, LinkedIn, Discord, and Telegram. Join fellow builders learning to ship with AI coding tools.',
...
const communities = [
  ...
  {
    name: 'LinkedIn',
    description: 'Follow our company page for professional updates and announcements.',
  ...
  {
    name: 'Telegram',
    description: 'Join our Telegram group for real-time discussions and updates.',
    href: 'https://t.me/claude_sydney',
    icon: (
      <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <div className="py-20">
      <Container>
        ...
        <div className="mx-auto mt-12 grid max-w-4xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-5">
