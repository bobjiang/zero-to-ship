...
**Dave Katague** — lecturer at UNSW (Cryptocurrencies & Decentralized Finance), research assistant in digital identity, and self-described "AI Enjoyooor" — shared a rapid-fire set of practical tips organized around four themes.

### Skills and Prompts

Dave highlighted the growing **skills ecosystem** — reusable capabilities you can install into any Claude Code project with a single command (`npx skills add <REPO_URL> --skill <SKILL_NAME>`). Resources like [skills.sh](https://skills.sh) and [ethskills.com](https://ethskills.com) are curating community-built skills.

For one-shotting big features or new projects, Dave shared his workflow:
...
Dave covered three workflow categories:
...
Dave shared his multi-model toolkit (as of March 31):
...
1. **Plan around 5-hour resets** — Structure your day so deep Claude sessions align with quota resets. Dave's move: message Claude "hi" 3-4 hours before a planned lock-in session to trigger the reset timer.
...
Dave's number one piece of advice: **"Just talk to it."** Referencing Peter Steinberger's post ["Just Talk To It — the no-bs Way of Agentic Engineering"](https://steipete.me/posts/just-talk-to-it), the message is simple: stop overthinking prompts. Just describe what you want in plain language.

His closing slide — a collage of projects he's built with AI tools — drove the point home: *"You can just do things."*

## Community Open Mic and Networking
...
For a detailed write-up from Dave's perspective, check out [his summary on Notion](https://dave-katague.notion.site/02ship-x-claude-sydney).
