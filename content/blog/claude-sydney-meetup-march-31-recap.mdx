---
title: "Claude Code Skills, Quota Maxxing & the Interview-Spec-Review Workflow - Claude Sydney Meetup - March 31, 2026"
excerpt: "5 takeaways from the Claude Sydney meetup: how to write Claude Code skills, quota-maxxing tips, and the interview-spec-review workflow."
date: "2026-03-31"
author: "Bob Jiang"
keywords: "Claude, meetup, Sydney, 02Ship, Claude Code, skills, prompts, quota, tips, non-coding, AI tools, community, recap"
---

# Claude Code Skills, Quota Maxxing & the Interview-Spec-Review Workflow

## TL;DR

- Write a **Claude Code skill** when you do something more than 3 times and quality matters.
- Use the **Interview → Spec → Codex review → Code** workflow for big features. Let Claude ask *you* the questions first.
- Run `/model opusplan` - Opus for plan mode, Sonnet for coding. Cheaper and faster.
- Plan your day around the **5-hour quota reset**, and use handover prompts to switch tools mid-session.
- "Just talk to it." Stop overthinking prompts - describe what you want in plain language.
...
![Attendees at the Claude Sydney meetup March 31](/images/claude-sydney-meetup-march-31-2026.jpg)
