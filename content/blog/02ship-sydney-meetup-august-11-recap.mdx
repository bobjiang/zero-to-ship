...
Thanks to **[CloudBridge](https://aws.cloud-bridge.au/)** for sponsoring the night, and **Haymarket HQ** for hosting us.
...
Thanks again to **[CloudBridge](https://aws.cloud-bridge.au/)**. They offered up to **$100K in AWS cloud credits** to builders in the room, and shared a QR code at the event. If you missed it, come to the next meetup and ask.
