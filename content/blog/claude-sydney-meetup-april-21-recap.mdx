---
title: "14 Claude Code Workflows Worth Stealing & a Weekend Build to Prod — Claude Sydney Meetup — April 21, 2026"
excerpt: "5 lessons from the April Claude Sydney meetup: 14 Claude Code workflows worth stealing and the real story of shipping a weekend build to prod."
date: "2026-04-21"
author: "Bob Jiang"
...
# 14 Claude Code Workflows Worth Stealing & a Weekend Build to Prod

## TL;DR

- Start with a **scope-killer** (Hermes / office-hours skill) before any coder touches the project.
- Match the tool to the stage — **Claude Code is a coder, not an architect**. Use the superpowers skill chain for specs and plans.
- Always get a **second model** to review your plan. Codex catches what Claude rationalizes.
- "Tests pass" ≠ "prod works". Env vars, secrets, and integrations live outside your repo.
- Make prod errors **observable**: wrap every external call in try/catch, log with a tag.
